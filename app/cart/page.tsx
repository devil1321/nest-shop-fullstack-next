      ...
      <div className="cart-inner md:flex md:justify-start">
        ...
        {cart.length > 0 
          ? <div className="cart-items md:w-[82%]">
            ...
            {cart.length > 0 && <Link onClick={()=>APIActions.updateCart(cart,user)} href="/checkout" className='block text-center mt-2 w-[100%] bg-blue-300 hover:bg-blue-200 text-white py-2 rounded-md font-bold'>Checkout</Link>}
          </div>
